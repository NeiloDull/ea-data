Ramd::define("groups", function(groups) {
  list(import = function() { run("2017/easurvey", to = "data"); df },
       ...
       analyze = list(
         ...
         list(
            "first heard"                   = function(df) tab(df, first_heard_EA, percent = TRUE, na.rm = TRUE)
          , "first local"                   = function(df) tab(df, first_local, percent = TRUE, na.rm = TRUE)
          , "involved_TLYCS"                = function(df) tab(df, involved_TLYCS, percent = TRUE, na.rm = TRUE)
          , "involved_local_EA"             = function(df) tab(df, involved_local_EA, percent = TRUE, na.rm = TRUE)
          , "involved_lesswrong"            = function(df) tab(df, involved_lesswrong, percent = TRUE, na.rm = TRUE)
          , "involved_givewell"             = function(df) tab(df, involved_givewell, percent = TRUE, na.rm = TRUE)
          , "involved_online_ea"            = function(df) tab(df, involved_online_ea, percent = TRUE, na.rm = TRUE)
          , "involved_personal_contact"     = function(df) tab(df, involved_personal_contact, percent = TRUE, na.rm = TRUE)
          , "involved_80K"                  = function(df) tab(df, involved_80K, percent = TRUE, na.rm = TRUE)
          , "involved_GWWC"                 = function(df) tab(df, involved_GWWC, percent = TRUE, na.rm = TRUE)
          , "involved EA Global"            = function(df) tab(df, involved_ea_global, percent = TRUE, na.rm = TRUE)
          , "involved Book or Blog"         = function(df) tab(df, involved_book_blog, percent = TRUE, na.rm = TRUE)
          , "involved Swiss"                = function(df) tab(df, involved_swiss, percent = TRUE, na.rm = TRUE)
          , "member_ea_fb"                  = function(df) tab(df, member_ea_fb, percent = TRUE, na.rm = TRUE)
          , "member_ea_forum"               = function(df) tab(df, member_ea_forum, percent = TRUE, na.rm = TRUE)
          , "member_gwwc"                   = function(df) tab(df, member_gwwc, percent = TRUE, na.rm = TRUE)
          , "member_lw"                     = function(df) tab(df, member_lw, percent = TRUE, na.rm = TRUE)
          , "ea social"                     = function(df) tab(df, ea_social, percent = TRUE, na.rm = TRUE)
          , "would attend"                  = function(df) tab(df, would_attend_local_group, percent = TRUE, na.rm = TRUE)
          , "ea_donate"                     = function(df) tab(df, ea_donate, percent = TRUE, na.rm = TRUE)
          ...
          , "ea_volunteer"                  = function(df) tab(df, ea_volunteer, percent = TRUE, na.rm = TRUE)
          ...
          , "ea_career"                     = function(df) tab(df, ea_career, percent = TRUE, na.rm = TRUE)
          ...
          , "ea_volunteer_hours"            = function(df) tab(df, ea_volunteer_hours, percent = TRUE, na.rm = TRUE)
          , "ea_career x member local"      = function(df) ctab(df, ea_career, member_local_group, na.rm = TRUE)
          , "ea_career x involved local"    = function(df) ctab(df, ea_career, involved_local_EA, na.rm = TRUE)
          , "ea_career x first local"       = function(df) ctab(df, ea_career, first_local, na.rm = TRUE)
          , "ea_career x would attend"      = function(df) ctab(df, ea_career, would_attend_local_group, na.rm = TRUE)
          ...
          , "ea_paid_hours"                 = function(df) tab(df, ea_paid_hours, percent = TRUE, na.rm = TRUE)
          ...
          , "Welcoming"                     = function(df) tab(df, ea_welcoming, percent = TRUE, na.rm = TRUE)
          ...
          , "EA NPS"                        = function(df) tab(df, ea_nps, percent = TRUE, na.rm = TRUE)
          ...
          , "student"                       = function(df) tab(df, student, percent = TRUE, na.rm = TRUE)
          , "student x member local"        = function(df) ctab(df, student, member_local_group, na.rm = TRUE)
          , "which year EA"                 = function(df) tab(df, which_year_EA, percent = TRUE, na.rm = TRUE)
          , "which year EA x member local"  = function(df) ctab(df, which_year_EA, member_local_group, na.rm = TRUE)
          , "GWWC member"                   = function(df) tab(df, member_gwwc, percent = TRUE, na.rm = TRUE)
          ...
          , "2016 Donate 1%?"                    = function(df) tab(df, filters(student == "No", income_2016_individual_c >= 10000, which_year_EA %not_in% c("2016", "2017")), p_donate_2016 >= 0.01, percent = TRUE, na.rm = TRUE)
          ...
          , "2016 Donate 10%?"                   = function(df) tab(df, filters(student == "No", income_2016_individual_c >= 10000, which_year_EA %not_in% c("2016", "2017")), p_donate_2016 >= 0.1, percent = TRUE, na.rm = TRUE)
          ...
          , "2016 GWWC adherence (non-student, GWWC member)"                  = function(df) tab(df, filters(student == "No",  which_year_EA %not_in% c("2016", "2017"), member_gwwc == "Yes"), p_donate_2016 >= 0.1, percent = TRUE, na.rm = TRUE)
          ...
          , "2016 GWWC adherence (non-student non-GWWC member)"               = function(df) tab(df, filters(student == "No",  which_year_EA %not_in% c("2016", "2017"), member_gwwc == "No"), p_donate_2016 >= 0.1, percent = TRUE, na.rm = TRUE)
          ...
          , "2016 GWWC adherence (student GWWC member)"                       = function(df) tab(df, filters(student == "Yes", which_year_EA %not_in% c("2016", "2017"), member_gwwc == "Yes"), p_donate_2016 >= 0.01, percent = TRUE, na.rm = TRUE)
          ...
          , "2015 Donate 1%?"                    = function(df) tab(df, filters(student == "No", income_2015_individual_c >= 10000, which_year_EA %not_in% c("2015", "2017")), p_donate_2015 >= 0.01, percent = TRUE, na.rm = TRUE)
          ...
          , "2015 Donate 10%?"                   = function(df) tab(df, filters(student == "No", income_2015_individual_c >= 10000, which_year_EA %not_in% c("2015", "2017")), p_donate_2015 >= 0.1, percent = TRUE, na.rm = TRUE)
          ...
          , "2015 GWWC adherence (non-student, GWWC member)"                 = function(df) tab(df, filters(student == "No",  which_year_EA %not_in% c("2015", "2016", "2017"), member_gwwc == "Yes"), p_donate_2015 >= 0.1, percent = TRUE, na.rm = TRUE)
          ...
          , "2015 GWWC adherence (non-student non-GWWC member)"              = function(df) tab(df, filters(student == "No",  which_year_EA %not_in% c("2015", "2016", "2017"), member_gwwc == "No"), p_donate_2015 >= 0.1, percent = TRUE, na.rm = TRUE)
          ...
          , "2015 GWWC adherence (student GWWC member)"                      = function(df) tab(df, filters(student == "Yes", which_year_EA %not_in% c("2015", "2016", "2017"), member_gwwc == "Yes"), p_donate_2015 >= 0.01, percent = TRUE, na.rm = TRUE)
          ...
          , "Cities of local groups"             		 = function(df) tab(df, filter(member_local_group == "Yes"), city, top = 10)
					...
					, "People in LEAN groups"              		 = function(df) tab(df, is_lean, percent = TRUE, na.rm = TRUE)
					...
					, "GWWC Membership x LEAN group"           = function(df) tab(df, member_gwwc, is_lean, percent = TRUE)
					, "GWWC Membership x LEAN group II"        = function(df) tab(df, member_gwwc, is_lean, percent = TRUE, na.rm = TRUE)
					, "GWWC Membership x LEAN group III"       = function(df) tab(df, filters(student == "No", income_2016_individual_c >= 10000, which_year_EA %not_in% c("2016", "2017")), member_gwwc, is_lean, percent = TRUE)
					, "GWWC Membership x LEAN group IV"        = function(df) tab(df, filters(student == "No", income_2016_individual_c >= 10000, which_year_EA %not_in% c("2016", "2017")), member_gwwc, is_lean, percent = TRUE, na.rm = TRUE)
