list(import = function() {
     ...
     analyze = list(
       ...
       list(
         ...
         , "cause AR II"              = function(df) tab(df, s15_cause_import_animal_welfare %in% c("This cause is the top priority", "This cause is near the top priority"), s17_cause_import_animal_welfare_b, percent = TRUE)
         , "cause import prioriti II" = function(df) tab(df, s15_cause_import_cause_prioritization %in% c("This cause is the top priority", "This cause is near the top priority"), s17_cause_import_cause_prioritization_b, percent = TRUE)
         , "cause import environm II" = function(df) tab(df, s15_cause_import_environmentalism %in% c("This cause is the top priority", "This cause is near the top priority"), s17_cause_import_environmentalism_b, percent = TRUE)
         , "cause AI II"              = function(df) tab(df, s15_cause_import_ai %in% c("This cause is the top priority", "This cause is near the top priority"), s17_cause_import_ai_b, percent = TRUE)
         , "cause non-AI II"          = function(df) tab(df, s15_cause_import_non_ai_far_future %in% c("This cause is the top priority", "This cause is near the top priority"), s17_cause_import_non_ai_far_future_b, percent = TRUE)
         , "cause poverty II"         = function(df) tab(df, s15_cause_import_poverty %in% c("This cause is the top priority", "This cause is near the top priority"), s17_cause_import_poverty_b, percent = TRUE)
         , "cause rationality II"     = function(df) tab(df, s15_cause_import_rationality %in% c("This cause is the top priority", "This cause is near the top priority"), s17_cause_import_rationality_b, percent = TRUE)
         , "cause politics II"        = function(df) tab(df, s15_cause_import_politics %in% c("This cause is the top priority", "This cause is near the top priority"), s17_cause_import_politics_b, percent = TRUE)
         , "cause meta II"            = function(df) tab(df, s15_cause_import_meta %in% c("This cause is the top priority", "This cause is near the top priority"), s17_cause_import_meta_b, percent = TRUE)
