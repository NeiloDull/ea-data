list(
  ...
  ,'renames' = c(
    'Response.ID' = 'id',
    'Could.you..however.loosely..be.described.as..an.EA..' = 'describeEA',
    'Your.age' = 'age',
    'What.moral.philosophy.do.you.subscribe.to..if.any.' = 'metaethics',
    'Which.of.the.following.causes.do.you.think.you.should.devote.resources.to...Global.poverty.' = 'poverty',
    'Which.of.the.following.causes.do.you.think.you.should.devote.resources.to...Environmentalism.' = 'environmentalism',
    'Which.of.the.following.causes.do.you.think.you.should.devote.resources.to...Animal.welfare.' = 'animals',
    'Which.of.the.following.causes.do.you.think.you.should.devote.resources.to...Improving.rationality.or.science.' = 'rationality',
    'Which.of.the.following.causes.do.you.think.you.should.devote.resources.to...Political.reform.' = 'politics',
    'Which.of.the.following.causes.do.you.think.you.should.devote.resources.to...Existential.risk..artificial.intelligence..' = 'ai',
    'Which.of.the.following.causes.do.you.think.you.should.devote.resources.to...Existential.risk..other..' = 'xrisk',
    'Which.of.the.following.causes.do.you.think.you.should.devote.resources.to...Far.future.concerns..besides.existential.risk..' = 'farfuture',
    'Which.of.the.following.causes.do.you.think.you.should.devote.resources.to...Cause.prioritization.' = 'prioritization',
    'Which.of.the.following.causes.do.you.think.you.should.devote.resources.to...Meta.charities.which.direct.resources.to.these.causes.' = 'metacharity',
    'Which.of.the.following.causes.do.you.think.you.should.devote.resources.to...Other.' = 'causeother',
    'What.is.your.diet.' = 'diet',
    'How.did.you.first.hear.about..Effective.Altruism..' = 'group',
    'Which.factors.were.important.in..getting.you.into..Effective.Altruism..or.altering.your.actions.in.its.direction...Personal.contact.with.an.EA.or.EAs.' = 'factors_contact',
    'Which.factors.were.important.in..getting.you.into..Effective.Altruism..or.altering.your.actions.in.its.direction...80.000.Hours.' = 'factors_80K',
    'Which.factors.were.important.in..getting.you.into..Effective.Altruism..or.altering.your.actions.in.its.direction...The.Life.You.Can.Save.' = 'factors_TLYCS',
    'Which.factors.were.important.in..getting.you.into..Effective.Altruism..or.altering.your.actions.in.its.direction...LessWrong.' = 'factors_LW',
    'Which.factors.were.important.in..getting.you.into..Effective.Altruism..or.altering.your.actions.in.its.direction...Giving.What.We.Can.' = 'factors_GWWC',
    'Which.factors.were.important.in..getting.you.into..Effective.Altruism..or.altering.your.actions.in.its.direction...GiveWell.' = 'factors_givewell',
    'Which.factors.were.important.in..getting.you.into..Effective.Altruism..or.altering.your.actions.in.its.direction...Friends.' = 'factors_friends',
    'Which.factors.were.important.in..getting.you.into..Effective.Altruism..or.altering.your.actions.in.its.direction...The.online.EA.community.' = 'factors_online',
    'Which.factors.were.important.in..getting.you.into..Effective.Altruism..or.altering.your.actions.in.its.direction...Local.chapter.of.an.EA.organisation.' = 'factors_chapter',
    'Over.2013..which.charities.did.you.donate.to...80.000.Hours.' = 'donate80K',
    'Over.2013..which.charities.did.you.donate.to...Against.Malaria.Foundation.' = 'donateAMF',
    'Over.2013..which.charities.did.you.donate.to...Animal.Charity.Evaluators..formerly.Effective.Animal.Activism..' = 'donateACE',
    'Over.2013..which.charities.did.you.donate.to...The.Centre.for.Effective.Altruism..unrestricted.donation..' = 'donateCEA',
    'Over.2013..which.charities.did.you.donate.to...Center.For.Applied.Rationality.' = 'donateCFAR',
    'Over.2013..which.charities.did.you.donate.to...Deworm.the.World.' = 'donateDTW',
    'Over.2013..which.charities.did.you.donate.to...GiveDirectly.' = 'donateGD',
    'Over.2013..which.charities.did.you.donate.to...GiveWell..itself..' = 'donateGW',
    'Over.2013..which.charities.did.you.donate.to...Giving.What.We.Can..itself..' = 'donateGWWC',
    'Over.2013..which.charities.did.you.donate.to...The.Humane.League.' = 'donateTHL',
    'Over.2013..which.charities.did.you.donate.to...Leverage.Research.' = 'donateLeverage',
    'Over.2013..which.charities.did.you.donate.to...Machine.Intelligence.Research.Institute.' = 'donateMIRI',
    'Over.2013..which.charities.did.you.donate.to...Project.Healthy.Children.' = 'donatePHC',
    'Over.2013..which.charities.did.you.donate.to...Schistosomiasis.Control.Initiative..SCI..' = 'donateSCI',
    'Over.2013..which.charities.did.you.donate.to...Vegan.Outreach.' = 'donateVO',
    'Roughly.how.many.of.your.friends.would.describe.themselves.as.Effective.Altruists.' = 'friendcount',
    'Are.you.a.full.time.student.' = 'student',
    'What.career.path.do.you.plan.to.follow.' = 'career',
    'Over.2013..how.much.in.total.did.you.donate.' = 'donate2013',
    'What.was.your.pre.tax.income.in.2013.' = 'income2013',
    'Referrer.URL' = 'referrer',
    'Postcode.Total.time.source' = 'referrer2',
    'Have.you.ever.heard.of.the.term..Effective.Altruism..or..EA..' = 'heardEA',
    'Your.gender' = 'gender',
    'Your.religious.beliefs' = 'religion',
    'In.which.country.do.you.live.' = 'location',
    'In.which.city.do.you.live.' = 'sublocation'
  )

  ,desired_variables = c('id', 'describeEA', 'metaethics', 'poverty', 'environmentalism', 'animals', 'rationality', 'politics', 'ai', 'xrisk', 'farfuture', 'prioritization', 'metacharity', 'causeother', 'diet', 'group', 'factors_contact', 'factors_80K', 'factors_TLYCS', 'factors_LW', 'factors_GWWC', 'factors_givewell', 'factors_friends', 'factors_online', 'factors_chapter', 'donate80K', 'donateAMF', 'donateACE', 'donateCEA', 'donateCFAR', 'donateDTW', 'donateGD', 'donateGW', 'donateGWWC', 'donateTHL', 'donateLeverage', 'donateMIRI', 'donatePHC', 'donateSCI', 'donateVO', 'friendcount', 'student', 'career', 'donate2013', 'income2013', 'referrer', 'referrer2', 'heardEA', 'gender', 'age', 'religion', 'location', 'sublocation')

  ,clean_group = list(
    list('80,000 Hours', '80K'),
    list('Animal Charity Evaluators (formerly Effective Animal Activism)', 'ACE'),
    list('Animal Charity Evaluators (formerly Effective Animal Activism)', 'ACE'),
    list('Animal Charity Evaluators (formerlyåÊEffective Animal Activism)', 'ACE'),
    list('Facebook', 'FB'),
    list('Friend', 'Friend'),
    list('GiveWell', 'GiveWell'),
    list('Giving What We Can', 'GWWC'),
    list('LessWrong', 'LW'),
    list('Search engine', 'Search'),
    list('TED Talk (Peter Singer)', 'TED'),
    list('The Life You Can Save', 'TLYCS'),
    list('local group', 'Local Group')
  )

  ,clean_city = list(
    list('San Francisco', 'Bay Area'),
    list('Berkeley', 'Bay Area'),
    list('New York City', 'New York'),
    list('Cambridge, MA', 'Boston'),
    list('Berkeley, CA', 'Bay Area'),
    list('Palo Alto', 'Bay Area'),
    list('Oakland, CA', 'Bay Area'),
    list('San Francisco Bay Area, CA', 'Bay Area'),
    list('Menlo Park', 'Bay Area'),
    list('Mountain View', 'Bay Area'),
    list('Los Altos, CA', 'Bay Area'),
    list('Berkeley, California, USA', 'Bay Area'),
    list('Berkeley CA', 'Bay Area'),
    list('berkeley', 'Bay Area'),
    list('Bay area', 'Bay Area'),
    list('Sunnyvale', 'Bay Area'),
    list('basel', 'Basel'),
    list('Lonodn', 'London'),
    list('london', 'London'),
    list('chicago, IL', 'Chicago'),
    list('Washington, DC', 'Washington DC'),
    list('seattle', 'Seattle'),
    list('oxford', 'Oxford'),
    list('Oxford and Bath', 'Oxford'),
    list('NYC', 'New York City'),
    list('NY', 'New York City'),
    list('New York ', 'New York City'),
    list('nyc', 'New York City'),
    list('Melbourne/Taree', 'Melbourne'),
    list('Melbourne (or near enough)', 'Melbourne'),
    list('Melbourne ', 'Melbourne'),
    list('Boston, MA', 'Boston'),
    list('Washington, D.C.', 'Washington DC'),
    list('Washington D.C.', 'Washington DC'),
    list('Vancouver, BC, Canada', 'Vancouver'),
    list('Vancouver ', 'Vancouver')
  )

  ,charity_vars = c('donateAMF', 'donateSCI', 'donateGD', 'donateMIRI', 'donateCFAR',
              'donateGW', 'donateDTW', 'donateVO', 'donateTHL', 'donate80K',
              'donateCEA', 'donatePHC', 'donateGWWC', 'donateACE', 'donateLeverage')
  ...
  ,referrer = list(
    ...
    list('s=18', 'OtherFB'),
    list('s=19', 'Special'),
    list('rockstar', 'Personal'),
    list('eah-profiles', 'EA Profiles'),
    list('t', 'Personal'),
    list('p', 'Personal')
  )

  ,referrer2 = list(
    list('An EA Facebook group', 'EAFB'),
    list('EA organisation', 'EA Org?'),
    list('Local group or chapter', 'Local group'),
    list('LessWrong', 'LW'),
    list('Elsewhere on Facebook or social media', 'FB elsewhere'),
    list('Animal Charity Evaluators (email, blog, etc.)', 'ACE')
  )
)
