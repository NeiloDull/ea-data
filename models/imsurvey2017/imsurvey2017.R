  ...
  list(
    ...
    , analyze = list(
      ...
      list(
        ...
        , "referrer3 x donation"          = function(df) ctab(df, filters(student == "No"), donate_2016_c, referrer3, na.rm = TRUE)
        , "referrer3 x income"            = function(df) ctab(df, filters(student == "No"), income_2016_individual_c, referrer3, na.rm = TRUE)
        , "referrer3 x % income donate"   = function(df) ctab(df, filters(student == "No", income_2016_individual_c > 9999), p_donate_2016, referrer3, na.rm = TRUE)    
